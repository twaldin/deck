 ...
 */
export const LINDY_TRAPS = `1. **Graphite lands-and-closes**: a queue-merged PR reads \`state=closed, merged=false\`. Before any "not landed" verdict, search main for the squash commit \`(#N)\`.
