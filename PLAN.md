...
4. **Migration** — efforts move over one by one; firstmate drained then stopped; proxies+grants+config sprawl deleted; instruction files collapsed.
