...
export default smithers((ctx) => {
  ...
  const reviewModel = new PiAgent({ provider: "deck", model: "gpt-5.6-sol", cwd: input.worktree, timeoutMs: 30 * 60_000, thinking: "medium", noSession: true, tools: ["read", "grep", "bash"] }); const fixModel = agent("gpt-5.6-luna", input.worktree); const rebaseModel = agent("gpt-5.6-luna", input.worktree);
  void policy;
