...
- **Landing correction (retracted claim):** my earlier "#25426 divergence" was FALSE. The landing check must verify the squash commit on main before judging a closed PR as absent. Classifier now resolves CLOSED PRs against main before judging; regression test added. Lesson logged: deck must absorb firstmate's learnings.md domain knowledge or it will manufacture false "firstmate is broken" signals.
