...
- **GitHub merge queue correction (retracted claim):** my earlier "#25426 divergence" was FALSE — it was a GitHub merge queue closes PRs before landing is confirmed (squash on main), firstmate was right. Classifier now resolves CLOSED PRs against main before judging; regression test added. Lesson logged: deck must absorb firstmate's learnings.md domain knowledge or it will manufacture false "firstmate is broken" signals.
